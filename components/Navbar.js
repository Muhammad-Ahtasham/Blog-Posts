    ...
    return (
        <nav className="p-4 bg-background/50 sticky top-0 backdrop-blur border-b z-10">
            ...
            <div className="container mx-auto flex justify-between items-center">
                <Link href={"https://atiiisham.vercel.app/"}><div className="text-lg font-bold">
                    ATIII
                </div></Link>
                <div className="hidden md:flex space-x-4 items-center">
                    <Link href="https://atiiisham.vercel.app/" className="hover:scale-105 hover:font-semibold transition-transform duration-300"> Home
                    </Link>
